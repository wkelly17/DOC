...
\newpagestyle{regularpage}{%
  \headrule
  \sethead[\textit{\firstextramarks{subsection}\subsectiontitle}][][\textit{\sectiontitle}]%
    {\textit{\sectiontitle}}{}{\textit{\firstextramarks{subsection}\subsectiontitle}}
  \setfoot{}{\thepage}{}
}
\makeatother
