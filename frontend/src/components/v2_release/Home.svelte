<script lang="ts">
  import { glLangCodeAndNamesStore, nonGlLangCodeAndNamesStore, langCountStore } from '../../stores/v2_release/LanguagesStore'
  ...
  import {emailStore} from '../../stores/v2_release/SettingsStore'
