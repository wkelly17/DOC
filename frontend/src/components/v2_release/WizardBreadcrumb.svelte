...
<div class="p-4 border border-[#E5E8EB]">
  <div class="flex items-center justify-between text-[#B3B9C2] leading-8 text-xl font-semibold">
    ...
    <div class="inline-flex items-center">
      <div class="avatar placeholder">
        {#if turnSettingsStepOn} <div class="bg-neutral-focus text-neutral-content rounded-full
                    w-8" style="background: linear-gradient(180deg, #1876FD 0%, #015AD9 100%);">
