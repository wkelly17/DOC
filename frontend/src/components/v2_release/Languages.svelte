...
<div class="bg-blue-700 p-4">
  <div class="flex items-center justify-between">
    <button>(left arrow) Back</button>
    <button>Language</button>
    <button>Books</button>
    <button>Resources</button>
    <button>Review</button>
    <button>Next (right arrow)</button>
  </div>
</div>
...
<div class="flex-grow flex flex-row overflow-hidden">
  ...
  <!-- right sidebar -->
  <div class="flex-shrink-0 w-1/3 p-4 overflow-y-auto">
    <h1 class="p-4 font-semibold text-xl">Your Selection</h1>
    <div class="inline-flex items-center">
      ...
      <h2 class="ml-2 font-semibold text-xl">Language</h2>
    </div>
    <div class="rounded-md p-6" style="background-color: #F2F3F5;">Selections will appear here once a language is selected</div>
    <div class="inline-flex items-center">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <h2 class="ml-2 font-semibold text-xl">Book</h2>
    </div>
    <div class="rounded-md p-6" style="background-color: #F2F3F5;">Selections will appear here once a book is selected</div>
    <div class="inline-flex items-center">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     <h2 class="ml-2 font-semibold text-xl">Resource</h2>
    </div>
    <div class="rounded-md p-6" style="background-color: #F2F3F5;">Selections will appear here once a resource is selected</div>
  </div>
</div>
