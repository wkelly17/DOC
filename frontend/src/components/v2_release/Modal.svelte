...
<div id="dialog-container" class="fixed pin z-50 overflow-y-auto bg-smoke-light flex">
  <div class="relative p-4 bg-white w-full max-w-md
              m-auto flex-col flex border-2
              border-[#e5e8eb] rounded-lg shadow-xl">
    <h3 class="font-bold text-lg text-[#33445C] mb-4">{title}</h3>
    <div class="content">
      <slot name="body" />
    </div>
    <div class="mt-4">
      <button class="rounded-md w-[115px] h-[48px] bg-white text-[#33445C]
