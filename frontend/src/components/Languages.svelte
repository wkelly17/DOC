<script lang="ts">
  ...
  $: {
    if (nonEmptyGatewayLanguages && nonEmptyHeartLanguages) {
      ...
      $resourceTypesStore = $resourceTypesStore.filter(item => $langCodesStore[0] === getResourceTypeLangCode(item) || $langCodesStore[1] === getResourceTypeLangCode(item))
...
<div class="flex-grow flex flex-row overflow-x-hidden overflow-y-auto">
  ...
  <div class="flex-1 flex flex-col sm:w-2/3 bg-white">
    <h3 class="ml-4 text-[#33445C] text-4xl font-normal leading-[48px]">Select up to 2 languages</h3>
                ...
                <svelte:fragment slot="body">
                  <div class="flex items-center">
                    <input
                      ...
                      />
                    <label for="show-gateway-radio-button" class="text-[#33445C] pl-1">Gateway languages</label>
                  </div>
                  <div class="flex items-center">
                    <input
                      ...
                      class="radio checked:bg-[#015ad9]"
                      />
                    <label for="show-heart-radio-button" class="text-[#33445C] pl-1">Heart languages</label>
                  </div>
                </svelte:fragment>
              </Modal>
            {/if}
