...
from document.domain.assembly_strategies.assembly_strategies_book_then_lang import (
    assemble_content_by_book_then_lang,
)
from document.domain.assembly_strategies.assembly_strategies_lang_then_book import (
